...
import { IonToolbar, IonButton, IonButtons, IonIcon, IonText } from "@ionic/vue";
import { IonCard, IonInfiniteScroll, IonInfiniteScrollContent, InfiniteScrollCustomEvent } from "@ionic/vue";
...
const ionInfinite = async (ev: InfiniteScrollCustomEvent) => {
    if (chapterStore.selectedChapter?.pagination?.next_page) {
        await chapterStore.getVerses(chapterStore.selectedChapter.id, true, chapterStore.selectedChapter?.pagination?.next_page)
