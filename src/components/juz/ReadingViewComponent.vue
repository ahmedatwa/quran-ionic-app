...
import { IonLabel, IonCardSubtitle, IonCardTitle, IonItem } from "@ionic/vue";
...
<template>
    <div class="ion-page" :id="`${id}-${juzId}`">
        ...
        <ion-content ref="contentRef">
            <ion-card class="ion-padding" v-for="(versesMap, page) in computedVerses" :key="page" :id="`row-page-${page}`"
                ref="cardRef">
