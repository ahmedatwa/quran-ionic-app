...
const handleVerseSearch = async (val: string | number) => {
    await presentLoading({ id: "loading-verses", duration: 1300 })
...
<template>
    <ion-input ref="input" id="verse-search-input" :error-text="inputError" @ion-blur="markTouched" :animated="true" :debounce="1500"
