...
import RecitersModalComponent from '@/components/modal/RecitersModalComponent.vue';
import TranslationsModalComponent from '@/components/modal/TranslationsModalComponent.vue';
// icons
import { cogOutline } from 'ionicons/icons';
// types
import { Recitations } from '@/types/audio';
...
const handleSelectedTranslations = (translationId: number) => {
    translationStore.selectedTranslationIds = [translationId]
        ...
        <ion-content :fullscreen="true">
            <div class="ion-padding">
                ...
                <ion-item button id="translations-modal">
                    <ion-label>{{ translationStore.groupedTranslationsAuthors }}</ion-label>
                </ion-item>
            ...
            <translations-modal-component :translations="translationStore.groupTranslationsByLanguage"
                    trigger="translations-modal" :presenting-element="pageRef"
                    :selected="translationStore.selectedTranslationIds"
                    @update:selected="handleSelectedTranslations"></translations-modal-component>
            <reciters-modal-component trigger="reciters-modal" :presenting-element="pageRef"
                :recitations="audioPlayerStore.mapRecitions" :selected-reciter="audioPlayerStore.selectedReciter"
                @update:selected-reciter="handleSelectedReciter">
            </reciters-modal-component>
        </ion-content>
    </ion-page>
